...
📊 Key Findings
1. Simulation (Manila City)
Metric,Baseline (All ON),OPTIC-5G (Optimized),Improvement
Active Nodes,243,22,🔻 90.9% Drop
Energy (Est),31.5 kW,2.86 kW,⚡ Massive Savings
Throughput,1.38 Mbps,1.20 Mbps,✅ Service Retained

2. Experimental (Physical Hardware)The physical deployment confirmed that turning off interfering nodes actually boosts signal quality.Mean SNR: Improved from 17.50 dB $\to$ 24.62 dB (+40.6%).Hardware Power: Reduced from 16 Routers $\to$ 8 Routers.

⚙️ Quick Start
1. Clone the Repo
git clone [https://github.com/your-username/OPTIC-5G.git](https://https://github.com/aguillonlei-alt/OPTIC-5G.git)
cd OPTIC-5G
